    ...
    <div className="container mx-auto px-4 py-8">
      {recognizedIngredients.length === 0 && (
        <div className="flex flex-col items-center justify-center text-center bg-card rounded-lg p-8 min-h-[400px]">
             <h3 className="font-headline text-2xl font-semibold">No Ingredients Scanned</h3>
             <p className="text-muted-foreground mt-2 mb-4">Upload a photo to find recipes you can make right now.</p>
             <Link href="/snap">
    ...
    return (
        <div className="container mx-auto px-4 py-8">
             <div className="flex flex-col items-center justify-center h-full min-h-[400px]">
                ...
                <p className="mt-4 text-lg text-muted-foreground">Finding delicious recipes for you...</p>
            </div>
        </div>
    )
}
